...
# DESCRIPTION
################################################################################
# The python script that controls and launches the inference. The script takes 
# the intial parameters and perform the inference a fixed number of times. The
# script is initiated multiple times by the bash script to avoid exceeding the 
# memory limit of the machine.
# PARAMETERS:
# :param: not explicitely required but given, the only argument passed to the
# script during its launching is the repeat, an integer as string.
# :param: neither defined nor given, the route to data.json. This JSON file 
# has all the parameters to perform the inference.
################################################################################
